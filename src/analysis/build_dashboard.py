...
<footer>
  ...
  <p><b>生成方式</b>：<code>python src/analysis/job_charts.py</code>（图1~7、10、11）｜<code>python src/analysis/map_job_distribution.py</code>（图8、9）｜本看板 <code>python src/analysis/build_dashboard.py</code>。</p>
  <p><b>数据文件</b>：<code>reports/figures/*.csv</code>（每张图的数据）｜<code>data/processed/</code>（清洗、分词与薪资规范化数据）｜<code>docs/可视化分析报告.md</code>（详细文字版）。</p>
</footer>
</body>
</html>
"""
